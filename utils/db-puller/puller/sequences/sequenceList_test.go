...
func TestSequenceList_DropLastItem(t *testing.T) {
	...
	require.ElementsMatch(t, want, got, "should drop last item from inner array")
...
func TestSequenceList_Get(t *testing.T) {
	...
	assert.ElementsMatch(t, want, got, "should get array from sequenceList struct")
...
func TestSequenceList_Len(t *testing.T) {
	...
	assert.Equal(t, 10, got, "should return proper got of sequenceList")
}
...
func TestSequenceList_Set(t *testing.T) {
	...
	require.ElementsMatch(t, want, got, "should set array in sequenceList struct")
